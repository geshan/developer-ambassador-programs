...
* [Codex Ambassador](https://developers.openai.com/codex/ambassadors) - Codex Ambassadors are community organizers, open-source maintainers, student leaders, and power users who actively spread what works, make Codex easier to adopt in practice, and help shape where it goes next. Codex is OpenAI’s coding agent for software development. 
