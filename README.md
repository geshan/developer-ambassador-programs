...
* [Agentic AI Ambassdor](https://aaif.io/learn-more-about-the-program) - If you’re passionate about AI and machine learning and love learning, building, sharing knowledge, and helping others grow in the field, join the AAIF Ambassadors program. This is an elite cohort of practitioners helping the world understand, use, and contribute to AAIF-hosted projects.
...
* [AWS Student Builder Campus Leader](https://builder.aws.com/content/3D2eETnWaTyI3XuyKX0T6flZrvq/aws-student-builder-campus-leaders) - AWS Student Builder Campus Leaders are paid, part-time student ambassadors who bring AWS Builder Center to life on their campuses by driving awareness of cloud tools and resources, hosting events, creating content, and inspiring peers to start building. * For students only. Unlike most programs on this list it is a paid role, currently available only in the United States, India, and Brazil.
* [AWS Student Builder Group Leader](https://builder.aws.com/community/student-builder-groups) - AWS Student Builder Group Leaders (formerly known as AWS Cloud Club Captains) are student leaders who form and launch AWS Student Builder Groups (formerly AWS Cloud Clubs) with AWS help and support. Group Leaders take on the responsibility to grow their group membership, host events, and support local initiatives. * For students only.
* [BrowserStack Champions](https://www.browserstack.com/browserstack-champions) - A global community of passionate QA experts, dedicated to advancing software quality, continuous learning, and making an impact in testing and development.
* [Claude Campus Program](https://claude.com/programs/campus) - Lead student-driven AI initiatives with Anthropic support. Apply to lead a Claude Builder Club or become a Campus Ambassador to advance AI education. If you’re passionate about building student communities, the Claude Builder Club program is for you. Has two programs: the Claude Builder Club program and the Claude Campus Ambassador. * For students only.
...
* [Codex Ambassadors](https://developers.openai.com/codex/ambassadors) - Codex Ambassadors are community organizers, open-source maintainers, student leaders, and power users who actively spread what works, make Codex easier to adopt in practice, and help shape where it goes next. Codex is OpenAI’s coding agent for software development. 
...
* [Devin.ai Ambassador](https://devin.ai/community) - Lead the Devin community in your city. Host events, create content, and shape what comes next.
...
* [GitHub Campus Experts](https://docs.github.com/en/education/explore-the-benefits-of-teaching-and-learning-with-github-education/use-github-at-your-educational-institution/applying-to-be-a-github-campus-expert) - Campus Experts are student leaders that strive to build diverse and inclusive spaces to learn skills, share their experiences, and build projects together. * For students only.
...
* [GeeksforGeeks Campus Mantri](https://www.geeksforgeeks.org/gfg-campus-mantri-program) - Campus Mantris represent GeeksforGeeks on their college campuses, helping build awareness, engage students, and promote learning and coding opportunities. * For students only.
...
* [Google Gemini Student Ambassador](https://geministudentambassador.com/) - A student ambassador program for students passionate about AI and Gemini, providing opportunities to build with Gemini, engage their campus community, and develop leadership and technical skills. * For students only.
* [Google Developer Experts](https://developers.google.com/community/experts) - Google Developer Experts (GDEs) is a global network of experienced developer professionals recognized by Google, who are actively supporting developers, startups and companies changing the world through web and mobile applications.
* [Google Developer Groups Organizer](https://developers.google.com/community/gdg) - Google Developer Groups (GDGs) are for developers who are interested in Google's developer technology; everything from the Android, Chrome, Drive, and Google Cloud platforms, to product APIs like the Cast API, Maps API, and YouTube API. * This is not really a Developer Ambassador program, but a good mention. This program has a student/university version called Google Developer Groups (GDG) On Campus, which is a students only program, that was called Google Developers Student Club in the past.
* [Google Women Techmakers Ambassador](https://developers.google.com/womentechmakers) - Google’s Women Techmakers program provides visibility, community, and resources for women in technology. * Women only and you can apply to be a WTM Ambassador.
...
* [Kiro Ambassadors](https://kiro.dev/ambassadors/) - Ambassadors get early access opportunities, a free Kiro subscription, and a direct line to the team building Kiro. In return, they share feedback, create content, host events, and support the community.
...
* [Mistral AI Ambassadors](https://docs.mistral.ai/resources/ambassadors) - Mistral experts who are passionate about our models and offerings, and who are committed to giving back to the community and supporting fellow members.
...
* [Tableau Ambassador Program](https://www.tableau.com/community/community-leaders/ambassadors) - For those who use Tableau (owned by Salesforce), a data analysis and business intelligence tool. The Tableau Ambassador Program recognizes active Tableau users who contribute to the community through forums, social media, and speaking engagements. 
